...
public abstract class BaseBottomDelegate extends LatteDelegate implements View.OnClickListener {
    ...
    //Test.
    public abstract int setCurrentDelegate();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mIndexDelegate = setCurrentDelegate();
    ...
    public void onBinderView(Bundle savedInstanceState, View rootView) {
        final int size = ITEMS.size();//单独赋值，减少ITEMS.size()计算次数
...
//        ISupportFragment
    ...
    public void onClick(View v) {
        ...
        final AppCompatTextView itemTitle = (AppCompatTextView) item.getChildAt(1);
        itemTitle.setTextColor(mClickedColor);
        //showHideFragment(显示的item，隐藏的item);
